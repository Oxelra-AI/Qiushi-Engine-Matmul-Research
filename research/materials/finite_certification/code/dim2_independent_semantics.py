...
analysis row builder.  It uses only the raw Wang LUT, orbit representatives,
...
RANK23_PATH = Path("data/pivot_fixed/pivot17_rank23_transformed_control.json")
OUTDIR = Path("data/dim2_independent")
OLD_SCRIPT_DIR = Path("scripts")
