...
| Maintained document identity | [Report build receipt](report-build.json) |
...
The cover date, 9 September 2026, records scientific completion. Build and
verification receipts retain their actual execution dates; the cover is not
a claim that every release artifact was built or publicly available that day.
