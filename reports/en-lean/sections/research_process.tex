...
\subsection{Research Memory and Evidence}
...
For Qiushi Engine, these records connect later decisions to earlier findings
and their conditions. For readers, they make the development of the method
inspectable: which observation changed a question, which counterexample
invalidated an inference, and which representation made a new proof possible.
The linked notes, programs and results also preserve intermediate methods
and open branches for further research. This evidence-linked account shows
how Qiushi Engine sustained mathematical research through changes of approach
and turned accumulated understanding into a structural proof.
...
\begin{figure}[tbp]
  \centering
  \makebox[\linewidth][c]{\input{figures/research_route}\unskip}
...
\begin{figure}[tbp]
  \centering
  \makebox[\linewidth][c]{\input{figures/proof_structure}\unskip}
