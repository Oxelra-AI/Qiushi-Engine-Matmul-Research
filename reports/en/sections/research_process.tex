...
lower-bound routes. The scientific report was completed on 9 September.
...
finite proof uses PySAT encodings, CaDiCaL proof generation, and
...
commands are collected in \qpath{reproducibility/README.md}.
...
Publishing this research trajectory extends the contribution beyond the
