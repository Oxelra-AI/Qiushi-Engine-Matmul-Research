...
preparation, after the research and scientific report had been completed.

The comparison below concerns Wang's published binary proof and its
reproduction package, and the proof and research record released here.
...
factors and place them in a common affine row or column coset. These are
substantive common reductions, not merely similar terminology. Restriction
...
certified by integer occupation encodings and CNF/DRAT refutations.\\
...
& Recheck the inherited certificate, reconstruct the eight occupation
systems, verify their DRAT proofs, and supply the subsequent algebraic
deduction in the report.\\
Further results
...
at most one first factor is invertible, leaving profiles $(17,5,0)$ and
$(18,3,1)$ in that slot.\\
\end{longtable}

The distinction is therefore more than replacing the last line of a
proof. The computations producing the finite premises differ; the use of
the common coset reduction differs; and the final contradiction changes
from first-factor capacity infeasibility to cross-factor algebra.
The common numerical conclusion does not make these mechanisms identical.

\paragraph{Research development and open materials.}
Wang supplies a reproducible theorem package, including code and
certificates. Our release also documents how the structural proof
