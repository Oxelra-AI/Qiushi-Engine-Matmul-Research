...
This wraps research's per-file verifier.  It reconstructs each actual DIMACS
...
DEFAULT_BATCH = Path('assets/structural/data/transparent_unary_certs_484_491/batch_transparent_unary_dim2_certs_manifest.json')
DEFAULT_OUTDIR = Path('assets/structural/data/transparent_lifting_batch')
VERIFIER = Path('assets/structural/scripts/transparent_cnf_lifting_verifier.py')
