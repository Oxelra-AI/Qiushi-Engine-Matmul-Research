#!/usr/bin/env python3
"""research independent checks of the normalized coset/AG(3,2) arithmetic.
...
LUT=Path('assets/quotients/data/wang_f2_lb20/wang_subspace_lut.pkl')
OUT=Path('assets/structural/data/coset/coset_plane_verify.json')
