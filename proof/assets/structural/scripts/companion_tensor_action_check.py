...
that link in the two coordinate conventions used in this analysis:
...
The proof-convention product formula with C^T was already checked in research.
"""
...
OUT = Path('assets/structural/data/tensor_action/companion_tensor_action_check.json')
