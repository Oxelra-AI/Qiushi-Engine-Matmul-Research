#!/usr/bin/env python3
"""research transport witnesses for the shortened rank>=21 proof package.

The research file-chain checker proved that core rows, CNF files and DRAT files
...
SCRIPTS = Path('assets/structural/scripts')
...
CORE_ROOT = Path('assets/structural/data/dim2_caplimited_cores_484_491')
OUT = Path('assets/structural/data/transport_witnesses/transport_witness_layer.json')
JSONL = Path('assets/structural/data/transport_witnesses/dim2_core_row_witnesses.jsonl')
