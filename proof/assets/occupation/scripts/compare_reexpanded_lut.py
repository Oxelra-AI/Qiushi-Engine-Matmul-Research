...
REEXP_BIN = Path("assets/occupation/data/wang_reexpand/reexpanded_lut.bin")
REEXP_SUMMARY = Path("assets/occupation/data/wang_reexpand/reexpand_summary.json")
OUT = Path("assets/occupation/data/wang_reexpand/reexpanded_lut_compare.json")
