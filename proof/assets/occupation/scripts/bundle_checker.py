#!/usr/bin/env python3
"""End-to-end checker for the research lower-bound certificate bundle.
...
The checker deliberately uses the independent research row/CNF reconstruction
...
ASSET_GROUP = Path("assets/occupation")
VERIFY_RECEIPT = Path("assets/quotients/data/wang_f2_lb20/verify_receipt.json")
WANG_CERT = Path("assets/quotients/data/wang_f2_lb20/cert_matrix_q02_n333.pb.txt")
CERT_DIR = Path("assets/occupation/data/dim2_cnf_cert_all")
INDEP_SUMMARY = Path("assets/occupation/data/dim2_independent/independent_semantics_summary.json")
ORBIT491_T19 = Path("assets/occupation/data/dim2_independent/orbit491_target19_long.json")
TRANSPOSE_JSON = Path("assets/occupation/data/audit/transpose_convention.json")
SATURATION_JSON = Path("assets/occupation/data/audit/saturation_proof.json")
GL3_JSON = Path("assets/occupation/data/audit/gl3_invariance.json")
COSET_JSON = Path("assets/occupation/data/audit/coset_lemma.json")
AG32_JSON = Path("assets/occupation/data/audit/ag32_cap.json")
OUT = Path("assets/occupation/data/bundle_check/bundle_check.json")
...
EXPECTED_LUT_SHA = "542df1f30fc362b292438696d90b76fb532093a431f8309e283aac83ebd6ac02"
...
def check_coset_planes(lut) -> dict:
    # Normalized S from research: <272,4,2,1>.  R=<4,2,1> is rank-one family.
    p = 272
    row_basis = [1,2,4]
