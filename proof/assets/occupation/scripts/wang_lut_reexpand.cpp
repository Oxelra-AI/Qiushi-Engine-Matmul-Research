...
// binary table.  It deliberately does not read the earlier orbit cache or LUT.
...
int main(int argc, char** argv) {
    std::string cert_path = "assets/quotients/data/wang_f2_lb20/cert_matrix_q02_n333.pb.txt";
    std::string out_bin = "assets/occupation/data/wang_reexpand/reexpanded_lut.bin";
    std::string out_json = "assets/occupation/data/wang_reexpand/reexpand_summary.json";
