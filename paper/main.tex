...
\begin{document}
\begin{abstract}
The exact bilinear complexity of $3\times3$ matrix multiplication over
$\mathbb F_2$ lies between $21$ and $23$. We give a structural proof of
the lower bound $21$ that converts occupation constraints on a single
...
bounds, is formalized in Lean. Qiushi Engine independently developed
the structural argument through long-horizon autonomous research on
shorter algorithms. The public research trajectory documents the
numerical diagnostics, quotient constructions, and corrections that
led from algorithm search to the structural proof.
\end{abstract}
\maketitle
\raggedbottom
