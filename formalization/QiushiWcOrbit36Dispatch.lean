...
import QiushiWcOrbit36Consumer
...
private theorem step109wc36s0_QtInv :
...
private theorem step109wc36s0_contain :
    (o36SourceU_wc ⟨0, by omega⟩) ≤ actionW (codeMat 267) (codeMat 161) orbit11W := by
  change spanCodes [256, 68, 36, 20, 8, 2, 1] ≤ actionW (codeMat 267) (codeMat 161) orbit11W
  apply step109wc36_spanCodes_le_of_gens [256, 68, 36, 20, 8, 2, 1]
...
theorem step109wc36s0Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨0, by omega⟩) 12 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 267) (codeMat 161) orbit11W) 12 :=
    @quotientRankAtLeast_action (codeMat 267) (codeMat 161) hP hQ orbit11W 12
      orbit11_lb12
  exact quotientRankAtLeast_mono step109wc36s0_contain hAct


private theorem step109wc36s1_QtInv :
    (codeMat 273 : Mat3).transpose⁻¹ = (codeMat 273 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 273 : Mat3).transpose * (codeMat 273 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s1_contain :
    (o36SourceU_wc ⟨1, by omega⟩) ≤ actionW (codeMat 273) (codeMat 273) orbit14W := by
  change spanCodes [256, 128, 96, 20, 8, 2, 1] ≤ actionW (codeMat 273) (codeMat 273) orbit14W
  apply step109wc36_spanCodes_le_of_gens [256, 128, 96, 20, 8, 2, 1]
...
theorem step109wc36s1Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨1, by omega⟩) 12 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 273) (codeMat 273) orbit14W) 12 :=
    @quotientRankAtLeast_action (codeMat 273) (codeMat 273) hP hQ orbit14W 12
      orbit14_lb12
  exact quotientRankAtLeast_mono step109wc36s1_contain hAct


private theorem step109wc36s2_QtInv :
    (codeMat 277 : Mat3).transpose⁻¹ = (codeMat 277 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 277 : Mat3).transpose * (codeMat 277 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s2_contain :
    (o36SourceU_wc ⟨2, by omega⟩) ≤ actionW (codeMat 401) (codeMat 277) orbit14W := by
  change spanCodes [256, 132, 96, 20, 8, 2, 1] ≤ actionW (codeMat 401) (codeMat 277) orbit14W
  apply step109wc36_spanCodes_le_of_gens [256, 132, 96, 20, 8, 2, 1]
...
theorem step109wc36s2Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨2, by omega⟩) 12 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 401) (codeMat 277) orbit14W) 12 :=
    @quotientRankAtLeast_action (codeMat 401) (codeMat 277) hP hQ orbit14W 12
      orbit14_lb12
  exact quotientRankAtLeast_mono step109wc36s2_contain hAct


private theorem step109wc36s3_QtInv :
    (codeMat 275 : Mat3).transpose⁻¹ = (codeMat 275 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 275 : Mat3).transpose * (codeMat 275 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s3_contain :
    (o36SourceU_wc ⟨3, by omega⟩) ≤ actionW (codeMat 273) (codeMat 275) orbit14W := by
  change spanCodes [256, 160, 96, 20, 8, 2, 1] ≤ actionW (codeMat 273) (codeMat 275) orbit14W
  apply step109wc36_spanCodes_le_of_gens [256, 160, 96, 20, 8, 2, 1]
...
theorem step109wc36s3Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨3, by omega⟩) 12 := by
  have hP : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 273) (codeMat 275) orbit14W) 12 :=
    @quotientRankAtLeast_action (codeMat 273) (codeMat 275) hP hQ orbit14W 12
      orbit14_lb12
  exact quotientRankAtLeast_mono step109wc36s3_contain hAct


private theorem step109wc36s4_QtInv :
    (codeMat 279 : Mat3).transpose⁻¹ = (codeMat 279 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 279 : Mat3).transpose * (codeMat 279 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s4_contain :
    (o36SourceU_wc ⟨4, by omega⟩) ≤ actionW (codeMat 401) (codeMat 279) orbit14W := by
  change spanCodes [256, 164, 96, 20, 8, 2, 1] ≤ actionW (codeMat 401) (codeMat 279) orbit14W
  apply step109wc36_spanCodes_le_of_gens [256, 164, 96, 20, 8, 2, 1]
...
theorem step109wc36s4Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨4, by omega⟩) 12 := by
  have hP : Invertible (codeMat 401 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 401) (codeMat 279) orbit14W) 12 :=
    @quotientRankAtLeast_action (codeMat 401) (codeMat 279) hP hQ orbit14W 12
      orbit14_lb12
  exact quotientRankAtLeast_mono step109wc36s4_contain hAct


private theorem step109wc36s5_QtInv :
    (codeMat 273 : Mat3).transpose⁻¹ = (codeMat 273 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 273 : Mat3).transpose * (codeMat 273 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s5_contain :
    (o36SourceU_wc ⟨5, by omega⟩) ≤ actionW (codeMat 273) (codeMat 273) flatW_7 := by
  change spanCodes [256, 96, 16, 8, 4, 2, 1] ≤ actionW (codeMat 273) (codeMat 273) flatW_7
  apply step109wc36_spanCodes_le_of_gens [256, 96, 16, 8, 4, 2, 1]
...
theorem step109wc36s5Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨5, by omega⟩) 9 := by
  have hP : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hQ : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hAct : QuotientRankAtLeast (actionW (codeMat 273) (codeMat 273) flatW_7) 9 :=
    @quotientRankAtLeast_action (codeMat 273) (codeMat 273) hP hQ flatW_7 9
      flatSeed_7
  exact quotientRankAtLeast_mono step109wc36s5_contain hAct

private def step109wc36s6SrcT : Submodule F2 Mat3 := spanCodes [256, 132, 64, 16, 8, 2, 1]

private theorem step109wc36s6SrcT_lb : QuotientRankAtLeast step109wc36s6SrcT 9 := by
  have ht := quotientRankAtLeast_transpose flatSeed_7
  have hle : step109wc36s6SrcT ≤ transposeW flatW_7 := by
    unfold step109wc36s6SrcT transposeW
...
private theorem step109wc36s6_QtInv :
    (codeMat 161 : Mat3).transpose⁻¹ = (codeMat 161 : Mat3).transpose := by
  apply Matrix.inv_eq_right_inv
  show (codeMat 161 : Mat3).transpose * (codeMat 161 : Mat3).transpose = 1
  ext i j <;> fin_cases i <;> fin_cases j <;> decide

private theorem step109wc36s6_contain :
    (o36SourceU_wc ⟨6, by omega⟩) ≤ actionW (codeMat 98) (codeMat 161) step109wc36s6SrcT := by
  change spanCodes [256, 64, 32, 20, 8, 2, 1] ≤ actionW (codeMat 98) (codeMat 161) step109wc36s6SrcT
  apply step109wc36_spanCodes_le_of_gens [256, 64, 32, 20, 8, 2, 1]
    (actionW (codeMat 98) (codeMat 161) step109wc36s6SrcT)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  rcases hn with h0 | h1 | h2 | h3 | h4 | h5 | h6
  · subst h0
    have hw : codeMat 16 ∈ step109wc36s6SrcT :=
  ...
  · subst h1
    ...
    exact step109wc36_codeMat_mem_actionW_of_witness hw hact
  · subst h2
    have hw : codeMat 2 ∈ step109wc36s6SrcT :=
    ...
    exact step109wc36_codeMat_mem_actionW_of_witness hw hact
  · subst h3
    have hw : codeMat 132 ∈ step109wc36s6SrcT :=
    ...
    exact step109wc36_codeMat_mem_actionW_of_witness hw hact
  · subst h4
    have hw : codeMat 1 ∈ step109wc36s6SrcT :=
    ...
    exact step109wc36_codeMat_mem_actionW_of_witness hw hact
  · subst h5
    have hw : codeMat 256 ∈ step109wc36s6SrcT :=
    ...
    exact step109wc36_codeMat_mem_actionW_of_witness hw hact
  · subst h6
    have hw : codeMat 64 ∈ step109wc36s6SrcT :=
...
theorem step109wc36s6Dispatch :
    QuotientRankAtLeast (o36SourceU_wc ⟨6, by omega⟩) 9 := by
  have hP : Invertible (codeMat 98 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hQ : Invertible (codeMat 161 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hAct : QuotientRankAtLeast (actionW (codeMat 98) (codeMat 161) step109wc36s6SrcT) 9 :=
    @quotientRankAtLeast_action (codeMat 98) (codeMat 161) hP hQ step109wc36s6SrcT 9
      step109wc36s6SrcT_lb
  exact quotientRankAtLeast_mono step109wc36s6_contain hAct

theorem step109wc36_all_dispatch (i : Fin 7) :
    QuotientRankAtLeast (o36SourceU_wc i) (o36SourceLb_wc i) := by
  fin_cases i
  · exact step109wc36s0Dispatch
  · exact step109wc36s1Dispatch
  · exact step109wc36s2Dispatch
  · exact step109wc36s3Dispatch
  · exact step109wc36s4Dispatch
  · exact step109wc36s5Dispatch
  · exact step109wc36s6Dispatch

theorem step109_orbit36_lb13_wc : QuotientRankAtLeast o36W_wc 13 :=
  o36Lb13_wc step109wc36_all_dispatch
