...
private theorem o108from29_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o108from29_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 108, basis [160, 84, 8, 2, 1]. -/
def o108W_mono : Submodule F2 Mat3 := spanCodes [160, 84, 8, 2, 1]

private theorem o108from29_QtInv :
...
private theorem o108W_le_action_29 :
    o108W_mono ≤ actionW (codeMat 266) (codeMat 266) orbit29W := by
  apply o108from29_spanCodes_le_of_gens [160, 84, 8, 2, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 266) (codeMat 266) (codeMat 68) = codeMat 160 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o108from29_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit108_lb15_mono : QuotientRankAtLeast o108W_mono 15 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 266) (codeMat 266) orbit29W) 15 :=
    @quotientRankAtLeast_action (codeMat 266) (codeMat 266) hP hQ orbit29W 15
      orbit29_lb15
  exact quotientRankAtLeast_mono o108W_le_action_29 hAct
