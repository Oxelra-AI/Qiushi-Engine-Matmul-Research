...
private theorem o43from14_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o43from14_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 43, basis [272, 128, 32, 8, 2, 1]. -/
def o43W_mono : Submodule F2 Mat3 := spanCodes [272, 128, 32, 8, 2, 1]

private theorem o43from14_QtInv :
...
private theorem o43W_le_action_14 :
    o43W_mono ≤ actionW (codeMat 161) (codeMat 266) orbit14W := by
  apply o43from14_spanCodes_le_of_gens [272, 128, 32, 8, 2, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 161) (codeMat 266) (codeMat 96) = codeMat 272 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o43from14_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit43_lb12_mono : QuotientRankAtLeast o43W_mono 12 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 161) (codeMat 266) orbit14W) 12 :=
    @quotientRankAtLeast_action (codeMat 161) (codeMat 266) hP hQ orbit14W 12
      orbit14_lb12
  exact quotientRankAtLeast_mono o43W_le_action_14 hAct
