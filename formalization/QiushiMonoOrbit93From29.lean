...
private theorem o93from29_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o93from29_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 93, basis [68, 16, 8, 2, 1]. -/
def o93W_mono : Submodule F2 Mat3 := spanCodes [68, 16, 8, 2, 1]

private theorem o93from29_QtInv :
...
private theorem o93W_le_action_29 :
    o93W_mono ≤ actionW (codeMat 266) (codeMat 266) orbit29W := by
  apply o93from29_spanCodes_le_of_gens [68, 16, 8, 2, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 266) (codeMat 266) (codeMat 160) = codeMat 68 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o93from29_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit93_lb15_mono : QuotientRankAtLeast o93W_mono 15 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 266) (codeMat 266) orbit29W) 15 :=
    @quotientRankAtLeast_action (codeMat 266) (codeMat 266) hP hQ orbit29W 15
      orbit29_lb15
  exact quotientRankAtLeast_mono o93W_le_action_29 hAct
