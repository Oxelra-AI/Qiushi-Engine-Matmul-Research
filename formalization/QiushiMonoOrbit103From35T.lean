...
private theorem o103from35_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o103from35_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 103, basis [132, 32, 8, 2, 1]. -/
def o103W_mono : Submodule F2 Mat3 := spanCodes [132, 32, 8, 2, 1]

private theorem o103from35_QtInv :
...
private theorem o103W_le_action_35 :
    o103W_mono ≤ actionW (codeMat 273) (codeMat 273) o35W_T := by
  apply o103from35_spanCodes_le_of_gens [132, 32, 8, 2, 1]
    (actionW (codeMat 273) (codeMat 273) o35W_T)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 273) (codeMat 273) (codeMat 132) = codeMat 132 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o103from35_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit103_lb15_mono : QuotientRankAtLeast o103W_mono 15 := by
  have hP : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hQ : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hAct : QuotientRankAtLeast (actionW (codeMat 273) (codeMat 273) o35W_T) 15 :=
    @quotientRankAtLeast_action (codeMat 273) (codeMat 273) hP hQ o35W_T 15
      o35W_T_lb
  exact quotientRankAtLeast_mono o103W_le_action_35 hAct
