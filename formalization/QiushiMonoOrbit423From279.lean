...
private theorem o423from279_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o423from279_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 423, basis [160, 10, 1]. -/
def o423W_mono : Submodule F2 Mat3 := spanCodes [160, 10, 1]

private theorem o423from279_QtInv :
...
private theorem o423W_le_action_279 :
    o423W_mono ≤ actionW (codeMat 266) (codeMat 266) o279W := by
  apply o423from279_spanCodes_le_of_gens [160, 10, 1]
    (actionW (codeMat 266) (codeMat 266) o279W)
  intro n hn
...
theorem orbit423_lb17_mono : QuotientRankAtLeast o423W_mono 17 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 266) (codeMat 266) o279W) 17 :=
    @quotientRankAtLeast_action (codeMat 266) (codeMat 266) hP hQ o279W 17
      step104_orbit279_lb17
  exact quotientRankAtLeast_mono o423W_le_action_279 hAct
