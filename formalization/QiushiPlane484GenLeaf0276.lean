...
def plane484GenLeaf0276Refs : Fin 44 → RowRef 1665 43 := ![.occ 120, .occ 123, .occ 125, .occ 130, .occ 139, .occ 179, .occ 220, .occ 228, .occ 450, .occ 553, .occ 556, .occ 614, .occ 767, .occ 1116, .occ 1136, .occ 1151, .occ 1154, .occ 1196, .occ 1220, .occ 1337, .occ 1357, .occ 1367, .occ 1419, .occ 1467, .occ 1567, .occ 1603, .occ 1606, .occ 1653, .occ 1661, .sumGe, .nonneg 5, .branchLe 15 (0), .branchGe 2 (1), .branchLe 7 (0), .branchLe 23 (0), .branchLe 26 (0), .branchGe 29 (1), .branchLe 34 (0), .branchLe 13 (0), .branchGe 37 (1), .branchLe 32 (0), .branchLe 8 (0), .branchGe 9 (1), .branchLe 41 (0)]

def plane484GenLeaf0276Mult : Fin 44 → Nat := ![499, 2760, 2550, 1360, 1442, 69, 1169, 1597, 3301, 862, 413, 2497, 2444, 1067, 249, 764, 2243, 1013, 748, 442, 1404, 1564, 236, 1083, 1013, 16, 1505, 1856, 609, 7457, 466, 6374, 2376, 3436, 2083, 6015, 2476, 7208, 2492, 8625, 5680, 2147, 19333, 7457]

theorem plane484GenLeaf0276 (x : Fin 43 → Int)
    ...
    (hUB_34 : x 34 ≤ (0 : Int))
    : False := by
  apply farkas_leaf_unsat (fun i j => (plane484GenLeaf0276Refs i).resolveCoeff plane484GenOccSys j)
    (fun i => (plane484GenLeaf0276Refs i).resolveRhs plane484GenOccSys) plane484GenLeaf0276Mult
    (by decide) (by decide) x
  intro i; fin_cases i <;> simp only [plane484GenLeaf0276Refs, Matrix.cons_val_zero, Matrix.cons_val_succ,
