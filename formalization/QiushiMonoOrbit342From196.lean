...
private theorem o342from196_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o342from196_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 342, basis [296, 100, 16, 1]. -/
def o342W_mono : Submodule F2 Mat3 := spanCodes [296, 100, 16, 1]

private theorem o342from196_QtInv :
...
private theorem o342W_le_action_196 :
    o342W_mono ≤ actionW (codeMat 330) (codeMat 354) o196W := by
  apply o342from196_spanCodes_le_of_gens [296, 100, 16, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 330) (codeMat 354) (codeMat 434) = codeMat 296 := by
      unfold actionA
      rw [o342from196_QtInv]
      show (codeMat 330 : Mat3).transpose * codeMat 434 * (codeMat 142 : Mat3).transpose = codeMat 296
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o342from196_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit342_lb16_mono : QuotientRankAtLeast o342W_mono 16 := by
  ...
  exact quotientRankAtLeast_mono o342W_le_action_196 hAct
