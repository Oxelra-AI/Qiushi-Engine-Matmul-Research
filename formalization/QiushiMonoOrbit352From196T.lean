...
private theorem o352from196_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o352from196_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 352, basis [136, 38, 20, 1]. -/
def o352W_mono : Submodule F2 Mat3 := spanCodes [136, 38, 20, 1]

private theorem o352from196_QtInv :
...
private theorem o352W_le_action_196 :
    o352W_mono ≤ actionW (codeMat 86) (codeMat 318) o196W_T := by
  apply o352from196_spanCodes_le_of_gens [136, 38, 20, 1]
    (actionW (codeMat 86) (codeMat 318) o196W_T)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 86) (codeMat 318) (codeMat 11) = codeMat 136 := by
      unfold actionA
      rw [o352from196_QtInv]
      show (codeMat 86 : Mat3).transpose * codeMat 11 * (codeMat 299 : Mat3).transpose = codeMat 136
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o352from196_codeMat_mem_actionW_of_witness hw hact
  · subst h1
    have hw : codeMat 312 ∈ o196W_T :=
      spanContainsCodeCore_implies_mem_spanCodes [306, 128, 96, 10, 1] 312 (by decide)
    have hact : actionA (codeMat 86) (codeMat 318) (codeMat 312) = codeMat 38 := by
      unfold actionA
      rw [o352from196_QtInv]
      show (codeMat 86 : Mat3).transpose * codeMat 312 * (codeMat 299 : Mat3).transpose = codeMat 38
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o352from196_codeMat_mem_actionW_of_witness hw hact
  · subst h2
    have hw : codeMat 472 ∈ o196W_T :=
      spanContainsCodeCore_implies_mem_spanCodes [306, 128, 96, 10, 1] 472 (by decide)
    have hact : actionA (codeMat 86) (codeMat 318) (codeMat 472) = codeMat 20 := by
      unfold actionA
      rw [o352from196_QtInv]
      show (codeMat 86 : Mat3).transpose * codeMat 472 * (codeMat 299 : Mat3).transpose = codeMat 20
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o352from196_codeMat_mem_actionW_of_witness hw hact
  · subst h3
    have hw : codeMat 128 ∈ o196W_T :=
      spanContainsCodeCore_implies_mem_spanCodes [306, 128, 96, 10, 1] 128 (by decide)
    have hact : actionA (codeMat 86) (codeMat 318) (codeMat 128) = codeMat 1 := by
      unfold actionA
      rw [o352from196_QtInv]
      show (codeMat 86 : Mat3).transpose * codeMat 128 * (codeMat 299 : Mat3).transpose = codeMat 1
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o352from196_codeMat_mem_actionW_of_witness hw hact

theorem orbit352_lb16_mono : QuotientRankAtLeast o352W_mono 16 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 86) (codeMat 318) o196W_T) 16 :=
    @quotientRankAtLeast_action (codeMat 86) (codeMat 318) hP hQ o196W_T 16
      o196W_T_lb
  exact quotientRankAtLeast_mono o352W_le_action_196 hAct
