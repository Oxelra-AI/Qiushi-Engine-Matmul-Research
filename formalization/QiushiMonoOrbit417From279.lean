...
private theorem o417from279_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o417from279_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 417, basis [16, 10, 1]. -/
def o417W_mono : Submodule F2 Mat3 := spanCodes [16, 10, 1]

private theorem o417from279_QtInv :
...
private theorem o417W_le_action_279 :
    o417W_mono ≤ actionW (codeMat 266) (codeMat 266) o279W := by
  apply o417from279_spanCodes_le_of_gens [16, 10, 1]
...
theorem orbit417_lb17_mono : QuotientRankAtLeast o417W_mono 17 := by
  ...
  exact quotientRankAtLeast_mono o417W_le_action_279 hAct
