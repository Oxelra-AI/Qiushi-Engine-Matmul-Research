...
def plane282GenLeaf0010Refs : Fin 24 → RowRef 100 28 := ![.occ 4, .occ 9, .occ 37, .occ 48, .occ 52, .occ 60, .occ 61, .occ 66, .occ 69, .occ 74, .occ 76, .occ 87, .sumGe, .nonneg 11, .nonneg 17, .nonneg 19, .nonneg 20, .nonneg 24, .nonneg 26, .branchLe 18 (0), .branchLe 22 (1), .branchGe 25 (1), .branchGe 0 (3), .branchLe 8 (1)]

def plane282GenLeaf0010Mult : Fin 24 → Nat := ![2, 2, 1, 2, 1, 2, 2, 1, 1, 1, 1, 1, 3, 2, 2, 4, 2, 2, 2, 2, 2, 4, 4, 2]

theorem plane282GenLeaf0010 (x : Fin 28 → Int)
    ...
    (hUB_8 : x 8 ≤ (1 : Int))
    : False := by
  apply farkas_leaf_unsat (fun i j => (plane282GenLeaf0010Refs i).resolveCoeff plane282GenOccSys j)
    (fun i => (plane282GenLeaf0010Refs i).resolveRhs plane282GenOccSys) plane282GenLeaf0010Mult
    (by decide) (by decide) x
  intro i; fin_cases i <;> simp only [plane282GenLeaf0010Refs, Matrix.cons_val_zero, Matrix.cons_val_succ,
