...
private theorem o71from17_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o71from17_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 71, basis [128, 68, 32, 20, 10, 1]. -/
def o71W_mono : Submodule F2 Mat3 := spanCodes [128, 68, 32, 20, 10, 1]

private theorem o71from17_QtInv :
...
private theorem o71W_le_action_17 :
    o71W_mono ≤ actionW (codeMat 87) (codeMat 282) step81o17s4Wspan := by
  apply o71from17_spanCodes_le_of_gens [128, 68, 32, 20, 10, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 87) (codeMat 282) (codeMat 219) = codeMat 128 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o71from17_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit71_lb14_mono : QuotientRankAtLeast o71W_mono 14 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 87) (codeMat 282) step81o17s4Wspan) 14 :=
    @quotientRankAtLeast_action (codeMat 87) (codeMat 282) hP hQ step81o17s4Wspan 14
      step81o17s4Span_lb
  exact quotientRankAtLeast_mono o71W_le_action_17 hAct
