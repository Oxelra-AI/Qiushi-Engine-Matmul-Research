...
private theorem o124from35_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o124from35_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 124, basis [256, 80, 12, 2, 1]. -/
def o124W_mono : Submodule F2 Mat3 := spanCodes [256, 80, 12, 2, 1]

private theorem o124from35_QtInv :
...
private theorem o124W_le_action_35 :
    o124W_mono ≤ actionW (codeMat 161) (codeMat 266) o35W_T := by
  apply o124from35_spanCodes_le_of_gens [256, 80, 12, 2, 1]
    (actionW (codeMat 161) (codeMat 266) o35W_T)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 161) (codeMat 266) (codeMat 32) = codeMat 256 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o124from35_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit124_lb15_mono : QuotientRankAtLeast o124W_mono 15 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 161) (codeMat 266) o35W_T) 15 :=
    @quotientRankAtLeast_action (codeMat 161) (codeMat 266) hP hQ o35W_T 15
      o35W_T_lb
  exact quotientRankAtLeast_mono o124W_le_action_35 hAct
