...
theorem plane489GenSource0363 :
    QuotientRankAtLeast (spanCodes [256, 129, 64, 33, 16, 8, 5, 2]) 9 := by
  apply quotientRankAtLeast_weaken (n := 9) _ (by decide)
  exact quotientRankAtLeast_of_code_transport
    [256, 128, 68, 32, 20, 8, 2, 1] [(256, 3), (129, 68), (64, 1), (33, 88), (16, 32), (8, 8), (5, 128), (2, 256)]
    (codeMat 84) (codeMat 165) (codeMat 163) false
    (by decide) (by decide) (by decide) (by decide)
    QiushiMatmul.flatSeed_3

theorem plane489GenSource0364 :
