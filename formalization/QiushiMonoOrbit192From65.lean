...
private theorem o192from65_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o192from65_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 192, basis [340, 128, 32, 10, 1]. -/
def o192W_mono : Submodule F2 Mat3 := spanCodes [340, 128, 32, 10, 1]

private theorem o192from65_QtInv :
...
private theorem o192W_le_action_65 :
    o192W_mono ≤ actionW (codeMat 142) (codeMat 396) o65W := by
  apply o192from65_spanCodes_le_of_gens [340, 128, 32, 10, 1]
    (actionW (codeMat 142) (codeMat 396) o65W)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  rcases hn with h0 | h1 | h2 | h3 | h4
  · subst h0
    have hw : codeMat 239 ∈ o65W :=
      spanContainsCodeCore_implies_mem_spanCodes [260, 160, 68, 16, 10, 1] 239 (by decide)
    have hact : actionA (codeMat 142) (codeMat 396) (codeMat 239) = codeMat 340 := by
      unfold actionA
      rw [o192from65_QtInv]
      show (codeMat 142 : Mat3).transpose * codeMat 239 * (codeMat 106 : Mat3).transpose = codeMat 340
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o192from65_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit192_lb15_mono : QuotientRankAtLeast o192W_mono 15 := by
  ...
  exact quotientRankAtLeast_mono o192W_le_action_65 hAct
