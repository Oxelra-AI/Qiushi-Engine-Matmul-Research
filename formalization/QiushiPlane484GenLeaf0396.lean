...
def plane484GenLeaf0396Refs : Fin 43 → RowRef 1665 43 := ![.occ 119, .occ 121, .occ 124, .occ 127, .occ 129, .occ 133, .occ 136, .occ 137, .occ 138, .occ 143, .occ 707, .occ 839, .occ 840, .occ 843, .occ 1164, .occ 1166, .occ 1196, .occ 1208, .occ 1237, .occ 1481, .occ 1483, .occ 1484, .occ 1488, .occ 1496, .occ 1533, .occ 1567, .occ 1597, .occ 1607, .occ 1612, .occ 1633, .sumGe, .nonneg 11, .nonneg 12, .branchLe 15 (0), .branchGe 2 (1), .branchGe 7 (1), .branchLe 6 (0), .branchLe 31 (0), .branchLe 24 (0), .branchLe 37 (0), .branchGe 35 (1), .branchLe 30 (0), .branchLe 27 (0)]

def plane484GenLeaf0396Mult : Fin 43 → Nat := ![1961, 2643, 2132, 2827, 533, 1274, 1862, 1660, 2736, 3962, 2360, 334, 2146, 1382, 226, 2394, 3558, 2108, 1656, 1018, 252, 2196, 2360, 1362, 1252, 382, 1086, 1534, 930, 286, 9938, 314, 1086, 3194, 13828, 21926, 1400, 8576, 5456, 9938, 7032, 2738, 6232]

theorem plane484GenLeaf0396 (x : Fin 43 → Int)
    ...
    (hUB_31 : x 31 ≤ (0 : Int))
    : False := by
  apply farkas_leaf_unsat (fun i j => (plane484GenLeaf0396Refs i).resolveCoeff plane484GenOccSys j)
    (fun i => (plane484GenLeaf0396Refs i).resolveRhs plane484GenOccSys) plane484GenLeaf0396Mult
    (by decide) (by decide) x
  intro i; fin_cases i <;> simp only [plane484GenLeaf0396Refs, Matrix.cons_val_zero, Matrix.cons_val_succ,
