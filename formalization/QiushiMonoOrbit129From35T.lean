...
private theorem o129from35_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o129from35_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 129, basis [288, 132, 12, 2, 1]. -/
def o129W_mono : Submodule F2 Mat3 := spanCodes [288, 132, 12, 2, 1]

private theorem o129from35_QtInv :
...
private theorem o129W_le_action_35 :
    o129W_mono ≤ actionW (codeMat 177) (codeMat 282) o35W_T := by
  apply o129from35_spanCodes_le_of_gens [288, 132, 12, 2, 1]
    (actionW (codeMat 177) (codeMat 282) o35W_T)
  intro n hn
  simp only [List.mem_cons, List.not_mem_nil, or_false] at hn
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 177) (codeMat 282) (codeMat 32) = codeMat 288 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o129from35_codeMat_mem_actionW_of_witness hw hact
  · subst h1
    have hw : codeMat 220 ∈ o35W_T :=
      spanContainsCodeCore_implies_mem_spanCodes [132, 80, 32, 8, 2, 1] 220 (by decide)
    have hact : actionA (codeMat 177) (codeMat 282) (codeMat 220) = codeMat 132 := by
      unfold actionA
      rw [o129from35_QtInv]
      show (codeMat 177 : Mat3).transpose * codeMat 220 * (codeMat 267 : Mat3).transpose = codeMat 132
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o129from35_codeMat_mem_actionW_of_witness hw hact
  · subst h2
...
theorem orbit129_lb15_mono : QuotientRankAtLeast o129W_mono 15 := by
  ...
  have hAct : QuotientRankAtLeast (actionW (codeMat 177) (codeMat 282) o35W_T) 15 :=
    @quotientRankAtLeast_action (codeMat 177) (codeMat 282) hP hQ o35W_T 15
      o35W_T_lb
  exact quotientRankAtLeast_mono o129W_le_action_35 hAct
