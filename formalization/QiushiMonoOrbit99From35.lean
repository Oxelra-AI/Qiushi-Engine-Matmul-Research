...
private theorem o99from35_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o99from35_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 99, basis [160, 20, 8, 2, 1]. -/
def o99W_mono : Submodule F2 Mat3 := spanCodes [160, 20, 8, 2, 1]

private theorem o99from35_QtInv :
...
private theorem o99W_le_action_35 :
    o99W_mono ≤ actionW (codeMat 273) (codeMat 275) orbit35W := by
  apply o99from35_spanCodes_le_of_gens [160, 20, 8, 2, 1]
    (actionW (codeMat 273) (codeMat 275) orbit35W)
  intro n hn
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 273) (codeMat 275) (codeMat 224) = codeMat 160 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o99from35_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit99_lb15_mono : QuotientRankAtLeast o99W_mono 15 := by
  have hP : Invertible (codeMat 273 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hQ : Invertible (codeMat 275 : Mat3) := Matrix.invertibleOfIsUnitDet _ (by decide)
  have hAct : QuotientRankAtLeast (actionW (codeMat 273) (codeMat 275) orbit35W) 15 :=
    @quotientRankAtLeast_action (codeMat 273) (codeMat 275) hP hQ orbit35W 15
      orbit35_lb15
  exact quotientRankAtLeast_mono o99W_le_action_35 hAct
