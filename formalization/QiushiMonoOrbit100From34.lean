...
private theorem o100from34_spanCodes_le_of_gens (basis : List Nat) (U : Submodule F2 Mat3)
...
private theorem o100from34_codeMat_mem_actionW_of_witness
...
/-- Wang orbit 100, basis [256, 20, 8, 2, 1]. -/
def o100W_mono : Submodule F2 Mat3 := spanCodes [256, 20, 8, 2, 1]

private theorem o100from34_QtInv :
...
private theorem o100W_le_action_34 :
    o100W_mono ≤ actionW (codeMat 273) (codeMat 273) o34W := by
  apply o100from34_spanCodes_le_of_gens [256, 20, 8, 2, 1]
  ...
  · subst h0
    ...
    have hact : actionA (codeMat 273) (codeMat 273) (codeMat 256) = codeMat 256 := by
      ...
      ext i j <;> fin_cases i <;> fin_cases j <;> decide
    exact o100from34_codeMat_mem_actionW_of_witness hw hact
  · subst h1
...
theorem orbit100_lb14_mono : QuotientRankAtLeast o100W_mono 14 := by
  ...
  exact quotientRankAtLeast_mono o100W_le_action_34 hAct
